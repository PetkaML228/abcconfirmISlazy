...
local Window = Rayfield:CreateWindow({
    ...
    LoadingSubtitle        = "TDS: Reanimated Macro v2.3",
    Theme                  = "Default",
    ...
    if category == "Troops" and action == "Place" then
        ...
        task.spawn(function()
            WatchForNewTower(function(instance)
                ...
                -- Храним ID через атрибут, невидимый для игровых скриптов
...
print("══════════════════════════════════════════")
print("  TDS: Reanimated Macro  v2.3.0  загружен")
print("  RF: "..(RemoteFunction and "✔ OK" or "✘ НЕ НАЙДЕНА"))
print("══════════════════════════════════════════")

Notify("TDS: Reanimated Macro v2.3",
